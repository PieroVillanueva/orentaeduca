...
//           src="/icons/menu.svg"
//           alt="Menu"
//           className="lg:hidden cursor-pointer p-4"
...
//             <NavLink to="#" className="hover:text-secondary transition-all p-2">
//               Servicios
//             </NavLink>
//             <NavLink
//               to="/nosotros"
...
//       {/* Oscurece el fondo cuando está abierto */}
//       {menuOpen && (
//         <div
...
//       {/* Sidebar que aparece desde la izquierda */}
//       <div
//         className={`${
...
//           />
//         </NavLink>
//         <NavLink to="#" className="hover:text-secondary transition-all mb-4">
//           Servicios
//         </NavLink>
//         <NavLink
//           to="/nosotros"
