  ...
  return (
    <footer className="bg-primary-950 px-8">
      <div className="container mx-auto">
        ...
        <div className="flex flex-col items-center gap-4 md:flex-row justify-center md:gap-0 py-4 text-sm md:text-base text-typography-100">
          <Link
            to="/terminos-y-condiciones"
            className="hover:text-secondary mx-4"
          >
        ...
        <p className="text-center pb-4 pt-2 text-sm md:text-base text-typography-100">
          Copyright © 2024. Todos los derechos reservados. Images Designed by
          Freepik
        </p>
      </div>
